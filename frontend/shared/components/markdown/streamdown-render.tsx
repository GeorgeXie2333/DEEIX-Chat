...
export const StreamdownRender = React.memo(function StreamdownRender({
  ...
  // Keep Comi standard density (leading-7) for assistant content; accept user variant styling.
  const contentSpacingClassName =
    variant === "thinking" ? "space-y-1.5 leading-6" : variant === "user" ? "space-y-2 leading-7" : "space-y-3 leading-7";
