...
const (
	...
	AdapterOpenAIVideoGenerations = portllm.AdapterOpenAIVideoGenerations
...
type (
	...
	GeneratedVideoStatus         = portllm.GeneratedVideoStatus
	ReasoningDelta               = portllm.ReasoningDelta
	GenerateStreamEvent          = portllm.GenerateStreamEvent
	ModelItem                    = portllm.ModelItem
	RawChatCompletionOutput      = portllm.RawChatCompletionOutput
	RawChatCompletionStreamEvent = portllm.RawChatCompletionStreamEvent
