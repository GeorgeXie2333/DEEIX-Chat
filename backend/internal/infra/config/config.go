...
const (
	defaultAppName                      = "Comi AI"
	defaultBrandTitle                   = "Comi AI"
	defaultBrandShortName               = "Comi"
	defaultBrandDescription             = "Comi AI is a multi-model AI conversation system."
	defaultBrandLogoURL                 = "/logo.svg"
...
func matchesLegacyBuiltInPolicyWithoutGeminiInteractions(rules map[string][]string) bool {
	...
	specs := map[string]pathSpec{
		...
		"xai_responses": {
			...
			optional: []string{"min_p", "parallel_tool_calls", "store", "top_k"},
		},
		"xai_image": {
...
func Load() Config {
	...
	return Config{
		...
		BrandLogoURL:                 valueOrDefault(yc.Branding.LogoURL, defaultBrandLogoURL),
