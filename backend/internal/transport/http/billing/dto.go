...
type CreateCheckoutRequest struct {
	...
	AmountUSD        float64 `json:"amountUSD,omitempty" binding:"omitempty,min=0"`
...
type BillingConfigRequest struct {
	...
	FreeModelRateLimitRPM          *int                        `json:"freeModelRateLimitRPM,omitempty" binding:"omitempty,min=0"`
	FreeModelDailyLimit            *int                        `json:"freeModelDailyLimit,omitempty" binding:"omitempty,min=0"`
	FreeModelRateLimitExemptModels *[]string                   `json:"freeModelRateLimitExemptModels,omitempty"`
}
...
type NativeToolPricingRequest struct {
	ToolKey      string  `json:"toolKey,omitempty" binding:"required,max=128"`
	PriceUSD     float64 `json:"priceUSD,omitempty" binding:"min=0"`
	PriceNanousd int64   `json:"priceNanousd,omitempty" binding:"min=0"`
	Unit         string  `json:"unit,omitempty" binding:"max=32"`
	PriceLabel   string  `json:"priceLabel,omitempty" binding:"max=64"`
