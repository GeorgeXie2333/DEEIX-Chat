...
var exactErrorSpecs = map[string]errorSpec{
	...
	"video generation accepts at most one reference image":      {Code: "media.video_reference_too_many", Message: "video generation accepts at most one reference image"},
	"video reference image is invalid":                          {Code: "media.video_reference_invalid", Message: "video reference image is invalid"},
	"video reference image size must match selected resolution": {Code: "media.video_reference_size_mismatch", Message: "video reference image size must match selected resolution"},
	...
	"payment currency is not supported":                            {Code: "payment.currency_unsupported", Message: "payment currency is not supported"},
	"top-up amount is below minimum":                               {Code: "payment.top_up_below_minimum", Message: "top-up amount is below minimum"},
...
var fallbackMessages = map[string]string{
	...
	"payment.currency_unsupported":                      "payment currency is not supported",
	"payment.top_up_below_minimum":                      "top-up amount is below minimum",
