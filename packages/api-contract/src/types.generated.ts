...
export interface ChannelModelListResponseDoc {
  data: {
...
export interface ChatCompletionChoiceDoc {
  /** @example "tool_calls" */
...
export interface ChatCompletionRequestDoc {
  function_call?: object;
  functions?: LegacyFunctionDoc[];
...
export interface ChatCompletionResponseDoc {
  choices: ChatCompletionChoiceDoc[];
  created: number;
...
export interface ChatMessageDoc {
  content?: object;
  function_call?: LegacyFunctionCallDoc;
  name?: string;
  /** @example "user" */
  role: string;
  tool_call_id?: string;
  tool_calls?: ChatToolCallDoc[];
}

export interface ChatToolCallDoc {
  function: LegacyFunctionCallDoc;
  /** @example "call_1" */
  id?: string;
  /** @example "function" */
  type: string;
...
export interface ChatToolDoc {
  function: LegacyFunctionDoc;
  /** @example "function" */
  type: string;
}
...
export interface ConversationArchiveAttachmentDoc {
  detectedMIME?: string;
  fileCategory?: string;
  fileName: string;
  fileSize: number;
...
export interface ConversationArchiveDoc {
  conversation: ConversationArchiveMetadataDoc;
  exportedAt: string;
  messages: ConversationArchiveMessageDoc[];
  runs?: ConversationArchiveRunDoc[];
  schema: string;
}

export interface ConversationArchiveMessageDoc {
  attachments?: ConversationArchiveAttachmentDoc[];
  branchReason: string;
  ...
  processTrace?: ConversationArchiveProcessTraceDoc;
...
export interface ConversationArchiveMetadataDoc {
...
export interface ConversationArchiveProcessTraceDoc {
  enabled: boolean;
  events?: ConversationArchiveTraceEventDoc[];
  process?: ConversationArchiveTraceBlockDoc;
  promptTrace?: ConversationArchivePromptTraceDoc;
  status: string;
  tools?: ConversationArchiveTraceBlockDoc;
  upstreamThink?: ConversationArchiveTraceBlockDoc;
}

export interface ConversationArchivePromptBlockDoc {
  cacheable: boolean;
  kind: string;
  sourceCount: number;
  sourceRefs?: ConversationArchivePromptSourceRefDoc[];
  title: string;
  tokenEstimate: number;
}

export interface ConversationArchivePromptSourceRefDoc {
  sourceID: string;
  sourceType: string;
  title: string;
}

export interface ConversationArchivePromptTraceDoc {
  blocks: ConversationArchivePromptBlockDoc[];
...
export interface ConversationArchiveResponseDoc {
  data: ConversationArchiveDoc;
  errorMsg: string;
}

export interface ConversationArchiveRunDoc {
  cacheReadTokens: number;
  cacheWriteTokens: number;
  createdAt: string;
  endedAt?: string;
...
export interface ConversationArchiveTraceBlockDoc {
  contentMarkdown: string;
...
export interface ConversationArchiveTraceEventDoc {
  contentMarkdown: string;
  endedAt?: string;
  eventID: string;
  eventType: string;
...
export interface LegacyFunctionCallDoc {
  /** @example "{"city":"Paris"}" */
  arguments: string;
  /** @example "get_weather" */
  name: string;
...
export interface LegacyFunctionDoc {
...
export interface OpenapiModelListResponseDoc {
  data: ModelItemDoc[];
  /** @example "list" */
  object: string;
  /** @example true */
...
export namespace Admin {
  ...
  export namespace LlmModelsList {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = ChannelModelListResponseDoc;
  }
...
export namespace Conversations {
   ...
   * @name ImportCreate
   * @summary 导入单条会话 JSON
   * @request POST:/conversations/import
   * @secure
   */
  export namespace ImportCreate {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = ConversationArchiveRequest;
    export type RequestHeaders = {};
  ...
  export namespace ExportList2 {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = ConversationArchiveResponseDoc;
  }
...
export namespace V1 {
  ...
  export namespace ChatCompletionsCreate {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = ChatCompletionRequestDoc;
    export type RequestHeaders = {};
    export type ResponseBody = ChatCompletionResponseDoc;
  }
  ...
  export namespace ModelsList {
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = OpenapiModelListResponseDoc;
  }
}
